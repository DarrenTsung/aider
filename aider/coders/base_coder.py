...
class Coder:
    ...
    def check_for_file_mentions(self, content):
        ...
        addable_rel_fnames = self.get_addable_relative_files().union(set(self.abs_fnames_to_ranges.keys()))
    ...
    def get_addable_relative_files(self):
        ...
        only_files_fully_in_chat = set(self.get_inchat_relative_files()) - set(partial_inchat_files)
        return set(self.get_all_relative_files()) - only_files_fully_in_chat
